...
*ssh -A appuser@217.28.231.251 -p 22022*
где IP адрес 217.28.231.251 машины *bastion*

>PS C:\WINDOWS\system32> ssh -A appuser@217.28.231.251 -p 22022
ssh: connect to host 217.28.231.251 port 22022: Connection refused
...
Просмотр iptables на машине *bastion* показывает, что все порты открыты:
...
надо вносить в *ssh_config*. После этого команда:
*ssh -fNv -L 22022:localhost:22 10.128.0.12* запустилась на всех интерфейсах
...
Далее, подключаемся с локальной  рабочей машины, командой *ssh -A appuser@84.252.129.136 -p 22022* напрямую к someinternalhost, минуя bastion VM:
>PS C:\WINDOWS\system32> ssh -A appuser@84.252.129.136 -p 22022
Welcome to Ubuntu 16.04.7 LTS (GNU/Linux 4.4.0-142-generic x86_64)
...
*PS C:\WINDOWS\system32> ssh  -fNv -A appuser@84.252.129.136 -L 22022:localhost:22022 84.252.129.136*
...
Введем команду *ssh -A appuser@217.28.229.0 ssh 10.128.0.12*.

>PS C:\WINDOWS\system32> ssh -A appuser@217.28.229.0 ssh 10.128.0.12
